...
//             }
         ...
         if (distance != 0) {
             if (X < 0 && Y > 0) {
                 splineFL2(.3, distance);//this doesnt work Switched to FL2(back need to be tested) maybe swithc these two
             ...
             if (X > 0 && Y < 0) {//dont touch condition
                 splineBL(.3, distance);//this also works(back need to be tested)//maybe it doesnt work
             ...
             if (X > 0 && Y > 0) {
                 splineBR(.3, distance);//does this work, switched to BR
